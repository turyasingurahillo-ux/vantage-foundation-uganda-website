...
export const englishDictionary = {
  ...
  home: {
    ...
    heroTitle: "The challenges young people face are connected. So is our work.",
    heroDescription: "Vantage Foundation Uganda works alongside young people — roughly ages 10 to 25 — and their communities, on the connected foundations of a decent life: health, learning, livelihoods, safety and daily essentials.",
    exploreWork: "Explore our work",
    partnerWithUs: "Partner with us",
    whoWeAre: "Who we are",
    ourImpact: "Our impact",
    areasEyebrow: "What we do",
    areasTitle: "Connected areas of work",
    areasDescription: "Health, learning, economic capability, humanitarian support and essential services — designed to reinforce each other, because the needs communities face are connected too.",
    joinUs: "Work with us",
    finalTitle: "Partner with us — or help fund the next advantage",
    finalDescription: "Institutional partners and funders shape what Vantage can take on next; individual supporters keep the current work moving. Two clear routes, one community.",
...
const de: DeepPartial<Dictionary> = {
  ...
  home: {
    ...
    heroDescription: "Vantage Foundation Uganda arbeitet Seite an Seite mit jungen Menschen — etwa im Alter von 10 bis 25 Jahren — und ihren Gemeinschaften an den verbundenen Grundlagen eines guten Lebens: Gesundheit, Bildung, Existenzgrundlagen, Sicherheit und das täglich Notwendige.",
    exploreWork: "Unsere Arbeit entdecken", partnerWithUs: "Partner werden", whoWeAre: "Wer wir sind", ourImpact: "Unsere Wirkung", areasEyebrow: "Unsere Arbeit", areasTitle: "Verbundene Arbeitsbereiche",
    areasDescription: "Gesundheit, Bildung, wirtschaftliche Handlungsfähigkeit, humanitäre Unterstützung und grundlegende Versorgung — so konzipiert, dass sie einander verstärken, weil auch die Bedürfnisse der Gemeinschaften zusammenhängen.", joinUs: "Arbeiten Sie mit uns",
    finalTitle: "Partner werden — oder den nächsten Vorteil mitfinanzieren", finalDescription: "Institutionelle Partner und Fördernde bestimmen mit, was Vantage als Nächstes angehen kann; einzelne Unterstützerinnen und Unterstützer halten die laufende Arbeit in Gang. Zwei klare Wege, eine Gemeinschaft.",
...
const fr: DeepPartial<Dictionary> = {
  ...
  home: {
    ...
    heroDescription: "Vantage Foundation Uganda travaille aux côtés des jeunes — environ de 10 à 25 ans — et de leurs communautés, sur les fondations liées d'une vie digne : santé, apprentissage, moyens de subsistance, sécurité et besoins essentiels.",
    exploreWork: "Découvrir notre action", partnerWithUs: "Devenir partenaire", whoWeAre: "Qui sommes-nous", ourImpact: "Notre impact", areasEyebrow: "Notre action", areasTitle: "Des domaines d'action liés",
    areasDescription: "Santé, apprentissage, capacité économique, soutien humanitaire et services essentiels — conçus pour se renforcer mutuellement, parce que les besoins des communautés sont eux aussi liés.", joinUs: "Travaillez avec nous",
    finalTitle: "Devenez partenaire — ou financez la prochaine possibilité", finalDescription: "Les partenaires institutionnels et les financeurs déterminent ce que Vantage peut entreprendre ensuite ; les donateurs individuels font avancer le travail en cours. Deux voies claires, une même communauté.",
...
const es: DeepPartial<Dictionary> = {
  ...
  home: {
    ...
    heroDescription: "Vantage Foundation Uganda trabaja junto a los jóvenes —aproximadamente entre los 10 y los 25 años— y sus comunidades en los cimientos conectados de una vida digna: salud, aprendizaje, medios de vida, seguridad y necesidades esenciales.",
    exploreWork: "Descubre nuestro trabajo", partnerWithUs: "Asóciate con nosotros", whoWeAre: "Quiénes somos", ourImpact: "Nuestro impacto", areasEyebrow: "Nuestro trabajo", areasTitle: "Áreas de trabajo conectadas",
    areasDescription: "Salud, aprendizaje, capacidad económica, apoyo humanitario y servicios esenciales — diseñados para reforzarse entre sí, porque las necesidades de las comunidades también están conectadas.", joinUs: "Trabaja con nosotros",
    finalTitle: "Asóciate con nosotros — o ayuda a financiar la próxima ventaja", finalDescription: "Los socios institucionales y los financiadores determinan lo que Vantage puede abordar a continuación; los donantes individuales mantienen en marcha el trabajo actual. Dos rutas claras, una misma comunidad.",
...
const ar: DeepPartial<Dictionary> = {
  ...
  home: {
    ...
    heroDescription: "تعمل Vantage Foundation Uganda جنبًا إلى جنب مع الشباب — تقريبًا من سن 10 إلى 25 عامًا — ومجتمعاتهم على الأسس المترابطة لحياة كريمة: الصحة والتعلم وسبل العيش والسلامة والاحتياجات اليومية.",
    exploreWork: "استكشف عملنا", partnerWithUs: "كن شريكًا لنا", whoWeAre: "من نحن", ourImpact: "تأثيرنا", areasEyebrow: "عملنا", areasTitle: "مجالات عمل مترابطة",
    areasDescription: "الصحة والتعلم والقدرة الاقتصادية والدعم الإنساني والخدمات الأساسية — مصممة لتعزز بعضها بعضًا، لأن احتياجات المجتمعات مترابطة أيضًا.", joinUs: "اعمل معنا",
    finalTitle: "كن شريكًا لنا — أو ساعد في تمويل الميزة التالية", finalDescription: "الشركاء المؤسسيون والمانحون يحددون ما يمكن أن تتصدى له Vantage تاليًا؛ والداعمون الأفراد يبقون العمل الحالي مستمرًا. طريقان واضحان، ومجتمع واحد.",
