          ...
          <div className="mt-8 space-y-8 leading-relaxed text-muted-foreground">
            ...
            <div>
              ...
              <ul className="ml-6 list-disc space-y-2">
                <li>
                  ...
                  campaign, selected transfer route, Vantage matching
                  reference, transaction reference, and any message you
                  provide.
                </li>
                <li>
            ...
            <div>
              ...
              <p>
                ...
                credentials (PINs, OTPs, card numbers) &mdash; transfers are
                made outside this website through the donor&apos;s bank or a
                third-party transfer service. We record only the transfer route,
                the Vantage matching reference generated by the website, the
                transaction reference you provide, and the donation details
                described above.
              </p>
              <p className="mt-3">
            ...
            <p className="border-t border-border pt-6 text-sm text-muted-foreground">
              Last updated: September 2026. This policy is reviewed annually.
            </p>
          </div>
        </Container>
      </section>
